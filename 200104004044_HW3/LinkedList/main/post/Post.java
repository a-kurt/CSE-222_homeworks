...
public class Post {
    ...
    public boolean removeComment(String accountId, int interactionId) {
        for (int i = 0; i < this.comments.size(); i++) {
            if (this.comments.get(i).getAccountId().equals(accountId) && this.comments.get(i).getInteractionId() == interactionId) {
    ...
    public boolean removeLike(String accountId) {
        for (int i = 0; i < this.likes.size(); i++)
            if (this.likes.get(i).getAccountId().equals(accountId)) {
