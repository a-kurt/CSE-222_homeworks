package LDLinkedList.main.account;

import LDLinkedList.main.post.Post;
import LDLinkedList.main.interaction.*;
import LDLinkedList.main.message.Message;
import LDLinkedList.main.LDLinkedList.LDLinkedList;
...
public class Account {
    ...
    /**
     * LDLinkedList of posts of Account.
     */
    private LDLinkedList<Post> posts;

    /**
     * LDLinkedList of messages of Account.
     */
    private LDLinkedList<Message> messages;


    /**
     * LDLinkedList of account that user follows.
     */
    private LDLinkedList<Account> following;

    /**
     * LDLinkedList of account that user's followers
     */
    ...
    /**
     * LDLinkedList of blocked accounts.
     */
    private LDLinkedList<Account> blockedAccounts;

    /**
     * LDLinkedList of user's action.
     */
    private LDLinkedList<String> userActions;
    ...
    public Account(int accountId, String username, String birthdate, String location) throws IllegalArgumentException {
        ...
        this.messages = new LDLinkedList<Message>();
        ...
        this.userActions = new LDLinkedList<String>();
    ...
    public LDLinkedList<String> getUserActions() {
        return userActions;
    }
